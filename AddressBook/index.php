...
<html class="no-js" lang="en" dir="ltr">
	...
	<body>
		...
		<div class="reveal" id="altModal" data-reveal>
			<h4>Edit Contact</h4><hr>

			<form>
				<div class="row">
					<div class="large-6 columns">
						<label>First Name
							<input id="first_name_alt" type="text" placeholder="Enter First Name">
						</label>
					</div>

					<div class="large-6 columns">
						<label>Last Name
							<input id="last_name_alt" type="text" placeholder="Enter Last Name">
						</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="large-4 columns">
						<label>Email
							<input id="email_alt" type="email" placeholder="Enter Email Address">
						</label>
					</div>

					<div class="large-4 columns">
						<label>Phone Number
							<input id="phone_alt" type="text" placeholder="Enter Phone Number">
						</label>
					</div>

					<div class="large-4 columns">
						<label>Contact Group
							<select id="contact_group_alt">
								<option value="Family">Family</option>
								<option value="Friends">Friends</option>
								<option value="Business">Business</option>
							</select>
				...
				<div class="row">
					<div class="large-6 columns">
						<label>Address 1
							<input id="address_1_alt" type="text" placeholder="Place Addres 1">
						</label>
					</div>

					<div class="large-6 columns">
						<label>Address 2
							<input id="address_2_alt" type="text" placeholder="Place Addres 2">
						</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="large-4 columns">
						<label>City
							<input id="city_alt" type="text" placeholder="Enter City">
						</label>
					</div>
					...
					<div class="large-4 columns">
						<label>Zipcode
							<input id="zipcode_alt" type="text" placeholder="Enter Zipcode">
						</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="large-12 columns">
						<label>Notes
							<textarea id="notes_alt" placeholder="Enter Optional Notes"></textarea>
						</label>
					</div>
				</div>
			</form>

			<hr><div id="alt" class="add-btn button float-right" data-open="altModConf">Submit</div>
		...
		<div class="reveal" id="altModConf" data-reveal>
			<h5>Do you really want to edit this contact?</h5><br>
			<div class="button float-right confirm-update alert" data-close>Edit</div>
			<div class="button float-right cancel-alt" data-close>Cancel</div>
		</div>	
